...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/VIVADO_NKUST/SOC/S1/part1/part1.cache/wt [current_project]
  set_property parent.project_path C:/VIVADO_NKUST/SOC/S1/part1/part1.xpr [current_project]
  set_property ip_output_repo C:/VIVADO_NKUST/SOC/S1/part1/part1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet C:/VIVADO_NKUST/SOC/S1/part1/part1.runs/synth_1/part1.dcp
  link_design -top part1 -part xa7a12tcpg238-2I
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file part1_timing_summary_routed.rpt -pb part1_timing_summary_routed.pb -rpx part1_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file part1_bus_skew_routed.rpt -pb part1_bus_skew_routed.pb -rpx part1_bus_skew_routed.rpx"
